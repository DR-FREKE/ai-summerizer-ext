...
chrome.runtime.sendMessage({ type: "youtubeOrNot" }, function (res) {
    ...
    setTimeout(function () {
        ...
        transcript_btn === null || transcript_btn === void 0 ? void 0 : transcript_btn.click(); // if button is present and it's clicked, get section where transcript is
        ...
        if (content_wrapper) {
            ...
            var content_wrap = content_wrapper.querySelector("#content");
...
var getHTMLContent = function (path, ext_div) { return __awaiter(_this, void 0, void 0, function () {
    var response, html_content;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                html_content = _a.sent();
                ext_div.innerHTML = html_content;
                return [3 /*break*/, 4];
            case 3: throw new Error("error occured");
